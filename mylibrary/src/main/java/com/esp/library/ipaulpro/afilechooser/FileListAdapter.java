...
package com.esp.library.ipaulpro.afilechooser;
...
public class FileListAdapter extends BaseAdapter {
    ...
    private final static int ICON_FOLDER = R.drawable.esp_lib_drawable_ic_folder;
    private final static int ICON_FILE = R.drawable.esp_lib_drawable_ic_file;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null)
            row = mInflater.inflate(R.layout.esp_lib_file, parent, false);
