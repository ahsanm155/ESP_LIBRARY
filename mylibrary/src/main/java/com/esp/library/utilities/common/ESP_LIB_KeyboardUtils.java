...
public class ESP_LIB_KeyboardUtils implements ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private static HashMap<SoftKeyboardToggleListener, ESP_LIB_KeyboardUtils> sListenerMap = new HashMap<>();
    ...
    public static void addKeyboardToggleListener(Activity act, SoftKeyboardToggleListener listener)
    {
        ...
        sListenerMap.put(listener, new ESP_LIB_KeyboardUtils(act, listener));
    }
    ...
    public static void removeKeyboardToggleListener(SoftKeyboardToggleListener listener)
    {
        ...
        {
            ESP_LIB_KeyboardUtils k = sListenerMap.get(listener);
            k.removeListener();
    ...
    private ESP_LIB_KeyboardUtils(Activity act, SoftKeyboardToggleListener listener)
    {
        mCallback = listener;
