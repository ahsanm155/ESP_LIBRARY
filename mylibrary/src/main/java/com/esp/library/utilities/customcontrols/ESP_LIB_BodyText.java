...
public class ESP_LIB_BodyText extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public ESP_LIB_BodyText(Context context, String customFont) {
        super(context);
        if (!isInEditMode()) {
    ...
    public ESP_LIB_BodyText(Context context, AttributeSet attrs) {
        super(context, attrs);
