...
public class ESP_LIB_CustomButton extends androidx.appcompat.widget.AppCompatButton {

    private ESP_LIB_OnEnableListener _enableListner;
    private String fontName;

    public ESP_LIB_CustomButton(Context context, String customFont) {
        super(context);
        if (!isInEditMode()) {
    ...
    public ESP_LIB_CustomButton(Context context, AttributeSet attrs) {
        super(context, attrs);
