...
public abstract class ESP_LIB_EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public ESP_LIB_EndlessRecyclerViewScrollListener(LinearLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
    }

    public ESP_LIB_EndlessRecyclerViewScrollListener(FlexboxLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
    }

    public ESP_LIB_EndlessRecyclerViewScrollListener(GridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }

    public ESP_LIB_EndlessRecyclerViewScrollListener(StaggeredGridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
...
//                            Log.i(mTag, "!!!!currentpage:" + currentPage);
            ...
            if (!loading) {
                ...
                loading = true;
                ESP_LIB_Shared.getInstance().errorLogWrite(mTag, "request pageindex:" + currentPage + ",totalItemsCount:" + totalItemCount);
