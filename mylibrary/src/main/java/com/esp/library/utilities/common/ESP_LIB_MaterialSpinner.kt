 ...
 */
open class ESP_LIB_MaterialSpinner @JvmOverloads constructor(
    context: Context,
        ...
        set(value) {
            ...
            adapter?.apply {
                if (value in 0 until count) {
                    ...
                    editText.setText("")
                    onItemSelectedListener?.onNothingSelected(this@ESP_LIB_MaterialSpinner)
                }
            }
        }
    /**
            ...
            getContext().getDrawableCompat(
                getResourceId(
                    ...
                    getResourceId(
                        ...
                        R.drawable.esp_lib_drawable_ic_spinner_drawable
                    )
                ), getContext().theme
            ).let {
                setDrawable(it)
    ...
    fun performItemClick(view: View?, position: Int, id: Long): Boolean {
        return run {
            onItemClickListener?.let {
                ...
                it.onItemClick(this@ESP_LIB_MaterialSpinner, view, position, id)
                true
            } ?: false
        }.also {
    ...
    override fun onSaveInstanceState(): Parcelable? {
        return super.onSaveInstanceState()?.let {
            SavedState(it).apply {
            this.selection = this@ESP_LIB_MaterialSpinner.selection
            this.isShowingPopup = this@ESP_LIB_MaterialSpinner.popup.isShowing()
        }
        }
    }
    ...
    private inner class DialogPopup(
        ...
        override fun onClick(dialog: DialogInterface, which: Int) {
            this@ESP_LIB_MaterialSpinner.selection = which
            onItemClickListener?.let {
                this@ESP_LIB_MaterialSpinner.performItemClick(null, which, adapter?.getItemId(which) ?: 0L)
            }
            popup?.dismiss()
        }
    ...
    private inner class DropdownPopup(context: Context, attrs: AttributeSet?) :
        ListPopupWindow(context, attrs), SpinnerPopup {
         ...
         init {
            ...
            anchorView = this@ESP_LIB_MaterialSpinner
            isModal = true
            ...
            setOnItemClickListener { parent, v, position, id ->
                this@ESP_LIB_MaterialSpinner.selection = position
                onItemClickListener?.let {
                    this@ESP_LIB_MaterialSpinner.performItemClick(
                        v,
                        position,
    ...
    private inner class BottomSheetPopup(
        ...
        override fun show(position: Int) {
            ...
            popup = BottomSheetDialog(context).apply {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
                    textDirection = this@ESP_LIB_MaterialSpinner.textDirection
                    textAlignment = this@ESP_LIB_MaterialSpinner.textAlignment
                }
                setOnDismissListener { listener?.onDismiss() }
            }.also {
                it.show()
    ...
    interface OnItemSelectedListener {
         ...
         */
        fun onItemSelected(parent: ESP_LIB_MaterialSpinner, view: View?, position: Int, id: Long)
         ...
         */
        fun onNothingSelected(parent: ESP_LIB_MaterialSpinner)
    }
    ...
    interface OnItemClickListener {
         ...
         * @param [id] The row id of the item that was clicked.
         */
        fun onItemClick(parent: ESP_LIB_MaterialSpinner, view: View?, position: Int, id: Long)
    }
