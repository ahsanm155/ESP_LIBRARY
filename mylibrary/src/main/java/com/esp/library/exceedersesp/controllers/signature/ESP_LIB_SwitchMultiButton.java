 ...
 */
public class ESP_LIB_SwitchMultiButton extends View {
    ...
    public ESP_LIB_SwitchMultiButton(Context context) {
        this(context, null);
    }

    public ESP_LIB_SwitchMultiButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ESP_LIB_SwitchMultiButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ESP_LIB_SwitchMultiButton);
        mStrokeRadius = typedArray.getDimension(R.styleable.ESP_LIB_SwitchMultiButton_strokeRadius, STROKE_RADIUS);
        mStrokeWidth = typedArray.getDimension(R.styleable.ESP_LIB_SwitchMultiButton_strokeWidth, STROKE_WIDTH);
        mTextSize = typedArray.getDimension(R.styleable.ESP_LIB_SwitchMultiButton_textSize, TEXT_SIZE);
        mSelectedColor = typedArray.getColor(R.styleable.ESP_LIB_SwitchMultiButton_selectedColor, SELECTED_COLOR);
        mDisableColor = typedArray.getColor(R.styleable.ESP_LIB_SwitchMultiButton_disableColor, DISABLE_COLOR);
        mSelectedTab = typedArray.getInteger(R.styleable.ESP_LIB_SwitchMultiButton_selectedTab, SELECTED_TAB);
        String mTypeface = typedArray.getString(R.styleable.ESP_LIB_SwitchMultiButton_typeface);
        int mSwitchTabsResId = typedArray.getResourceId(R.styleable.ESP_LIB_SwitchMultiButton_switchTabs, 0);
    ...
    public ESP_LIB_SwitchMultiButton setOnSwitchListener(OnSwitchListener onSwitchListener) {
     ...
     * @return
     */
    public ESP_LIB_SwitchMultiButton setSelectedTab(int mSelectedTab) {
     ...
     * @return
     */
    public ESP_LIB_SwitchMultiButton setText(String... tagTexts) {
