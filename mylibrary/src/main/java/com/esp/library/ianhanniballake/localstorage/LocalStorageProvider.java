...
package com.esp.library.ianhanniballake.localstorage;
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_TITLE, getContext().getString(R.string.esp_lib_text_internal_storage));
        row.add(Root.COLUMN_FLAGS, Root.FLAG_LOCAL_ONLY | Root.FLAG_SUPPORTS_CREATE);
        row.add(Root.COLUMN_ICON, R.drawable.esp_lib_drawable_ic_provider);
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(LocalStorageProvider.class.getSimpleName(), getContext().getString(R.string.esp_lib_text_errorcreatingnewfile) + " " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            tempFile = File.createTempFile(getContext().getString(R.string.esp_lib_text_thumbnail), null, getContext().getCacheDir());
            out = new FileOutputStream(tempFile);
            bitmap.compress(Bitmap.CompressFormat.PNG, 90, out);
        } catch (IOException e) {
            Log.e(LocalStorageProvider.class.getSimpleName(), getContext().getString(R.string.esp_lib_text_errorwritingthumbnail), e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageProvider.class.getSimpleName(), getContext().getString(R.string.esp_lib_text_errorclosingthumbnail), e);
                }
        }
